        ...
        <header className="white-text-container section-container">
            <div className="text-center">
                ...
                <p>            
                    ...
                    <a className="fa-icon fa-icon-2x" href="https://www.facebook.com/aaquif.zubair" title="" target="_blank">
                    <i className="fa fa-facebook"></i>
                    </a>
                    <a className="fa-icon fa-icon-2x" href="https://twitter.com/aquifzubair" title="" target="_blank">
